...
namespace IJ_homeWork_Slavik
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("\nДля продолжения нажмите любую клавишу...");                              //Да дубляж кода, но без циклов или методов его не избежать.
            Console.ReadKey();
            Console.Clear();
            ...
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine("Относительно недавно мой создатель узнал, что на планете существует акула, живущая уже 518 лет.");   //попытка подводки к вопросу возраста
            Console.Write("\nДля продолжения нажмите любую клавишу...");
            Console.ReadKey();
            Console.Clear();
            ...
            string userAge = Console.ReadLine();                       //or bute userAge = Convert.ToByte(Console.ReadLine());
            ...
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine("...");                                  //имитация неловкой паузы.
            Console.Write("\nДля продолжения нажмите любую клавишу...");
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine("...");
